...
CORRECTION4: ;Leg 4 back towards start
	LOADI   200
	STORE	DVEL
	IN		XPOS
	ADDI	-590
...
CORRECTION2: ;Leg 2 towards TA desk
	LOADI   200
	STORE	DVEL
	IN		XPOS
	ADDI	-590
...
CORRECTION3: ;Leg 3 towards away from TA desk towards corner 1
	LOADI   200
	STORE	DVEL
	IN		XPOS
	ADDI	-590
