...
;WallFollow: In Dist5   		;read Dist5
			;out SSeg1  		;out value to SSeg1
			;Load FMID  		;use given speed(350)
			;Store DVEL 		;use Fmid as desired speed
			;OUT Timer		
			;JUMP Timer1
			
;Lowcheck: Load Low			;Low is output SSeg1 to verify too close to wall
		  ;Out SSEG1
		  ;IN Dist5
		  ;sub DesDist
		  ;JNEG CorrectLow			;if too close it stops for duration of timer 2
		  
;Highcheck: Load High		;High outputted to SSeg1 to verify too far from wall
		   ;Out SSEG1
		   ;IN Dist5
		   ;sub DesDist
		   ;JPOS CorrectHigh		;if too far it stops for duration of timer 2
		   ;Jump Timer2
